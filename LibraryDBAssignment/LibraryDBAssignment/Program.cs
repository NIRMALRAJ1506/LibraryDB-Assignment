...
namespace LibraryDBAssignment
{
    internal class Program
    {
        ...
        public static string constr = "server=DESKTOP-Q04HI42\\SQLEXPRESS;database=LibraryDB;trusted_connection=true;";
        static void Main(string[] args)
        {
            ...
            try
            {
                do
                {
                    Console.WriteLine("Choose the operation 1.Display Books 2.Add Books 3.Update Quantity");
